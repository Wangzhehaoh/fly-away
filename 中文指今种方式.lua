...
Title.TextSize = 18
Title.Text = "指今 FE 语言:" .. currentVersion
...
Keybinds = makeSettingsButton("编辑按键绑定","rbxassetid://129697930")
...
Positions = makeSettingsButton("编辑/前往航点","rbxassetid://5147488592")
...
PluginsHint.Text = "从discord.io/infiniteyield的IY不和谐下载插件"
...
PositionsHint.Text = "使用“swp”或“setwaypoint”命令来添加一个使用你的角色的位置(注意:部分传送将不会保存)"
...
PrefixBox:GetPropertyChangedSignal("Text"):Connect(function()
	...
	Cmdbar.PlaceholderText = "请输入指今 ("..prefix..")"
	updatesaves()
end)
...
CMDs[#CMDs + 1] = {NAME = 'follow [用户名] [跟玩家]', DESC = '跟玩家'}
CMDs[#CMDs + 1] = {NAME = 'unfollow [阻止跟]', DESC = '阻止跟玩家'}
CMDs[#CMDs + 1] = {NAME = 'naked [注意][默认自己能看见]', DESC = '要客户才能给别人看见'}
CMDs[#CMDs + 1] = {NAME = 'sitwalk [坐走]', DESC = '默认了坐可以走'}
CMDs[#CMDs + 1] = {NAME = 'nccam [允许摄像机穿过像墙壁这样的物体]', DESC = '允许摄像机穿过像墙壁这样的物体'}
CMDs[#CMDs + 1] = {NAME = 'firstp [镜头进入第一人称]', DESC = '你想成第一人称'}
CMDs[#CMDs + 1] = {NAME = 'thirdp [允许摄像机进入第三人称]', DESC = '你想成第三人称'}
CMDs[#CMDs + 1] = {NAME = 'reset [自杀]', DESC = '是重置人物'}
CMDs[#CMDs + 1] = {NAME = 'swim [游泳+空中]', DESC = '让你在空中游泳 默认速度10以上可移动'}
CMDs[#CMDs + 1] = {NAME = 'sit [允许你自坐下]', DESC = '默认可以自己坐'}
CMDs[#CMDs + 1] = {NAME = 'freecam [允许你在游戏中自由移动相机]', DESC = '允许你在游戏中自由移动相机'}
CMDs[#CMDs + 1] = {NAME = 'diedtp [把你传送到你最后死去的地方]', DESC = '默认你死了后 再用'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = '邀请到无限产量支持服务器'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = '加载旧的Roblox控制台'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = '按月打开DEX'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = '月亮打开旧德克斯'}
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy', DESC = '打开简单间谍V3'}
CMDs[#CMDs + 1] = {NAME = 'audiologger / alogger', DESC = '打开Edges音频记录器'}
CMDs[#CMDs + 1] = {NAME = 'serverinfo / info', DESC = '为您提供有关服务器的信息'}
CMDs[#CMDs + 1] = {NAME = 'jobid', DESC = '将游戏作业Id复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'notifyjobid', DESC = '通知您游戏作业Id'}
CMDs[#CMDs + 1] = {NAME = 'rejoin / rj', DESC = '让你重新加入游戏'}
CMDs[#CMDs + 1] = {NAME = 'autorejoin / autorj', DESC = '自动重新加入服务器，如果你被踢/断开'}
CMDs[#CMDs + 1] = {NAME = 'serverhop / shop', DESC = '将你传送到不同的服务器'}
CMDs[#CMDs + 1] = {NAME = 'joinplayer [用户名/ ID] [地点ID]', DESC = '加入特定的玩家服务器'}
CMDs[#CMDs + 1] = {NAME = 'gameteleport / gametp [地点ID]', DESC = '通过ID加入游戏'}
CMDs[#CMDs + 1] = {NAME = 'antiidle / antiafk', DESC = '防止游戏因为你无所事事而踢你/afk'}
CMDs[#CMDs + 1] = {NAME = 'datalimit [数字]', DESC = '设置传出KBPS限制'}
CMDs[#CMDs + 1] = {NAME = 'replicationlag / backtrack [数字]', DESC = '设置IncomingReplicationLag'}
CMDs[#CMDs + 1] = {NAME = 'creatorid / creator', DESC = '通知您创建者ID'}
CMDs[#CMDs + 1] = {NAME = 'copycreatorid / copycreator', DESC = '将创建者ID复制到您的剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'setcreatorid / setcreator', DESC = '将您的用户id设置为创建者ID'}
CMDs[#CMDs + 1] = {NAME = 'noprompts', DESC = '阻止游戏向您显示购买/奖励提示'}
CMDs[#CMDs + 1] = {NAME = 'showprompts', DESC = '允许游戏再次显示购买/奖励提示'}
...
CMDs[#CMDs + 1] = {NAME = 'showguis', DESC = '显示任何不可见的图形用户界面'}
CMDs[#CMDs + 1] = {NAME = 'unshowguis', DESC = '撤消显示'}
CMDs[#CMDs + 1] = {NAME = 'hideguis', DESC = '隐藏PlayerGui中的任何Gui'}
CMDs[#CMDs + 1] = {NAME = 'unhideguis', DESC = '撤消隐藏'}
CMDs[#CMDs + 1] = {NAME = 'guidelete', DESC = '启用退格删除GUI'}
CMDs[#CMDs + 1] = {NAME = 'unguidelete / noguidelete', DESC = '禁用指南'}
CMDs[#CMDs + 1] = {NAME = 'hideiy', DESC = '隐藏主IY图形用户界面'}
CMDs[#CMDs + 1] = {NAME = 'showiy / unhideiy', DESC = '再次展示了IY'}
CMDs[#CMDs + 1] = {NAME = 'keepiy', DESC = '通过服务器传送时自动执行IY'}
CMDs[#CMDs + 1] = {NAME = 'unkeepiy', DESC = '禁用保持'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepiy', DESC = '切换保持'}
CMDs[#CMDs + 1] = {NAME = 'savegame / saveplace', DESC = '使用saveinstance保存游戏'}
CMDs[#CMDs + 1] = {NAME = 'clearerror', DESC = '当游戏踢你时，清除恼人的框和模糊'}
CMDs[#CMDs + 1] = {NAME = 'clientantikick / antikick (客户)', DESC = '防止本地脚本踢你'}
CMDs[#CMDs + 1] = {NAME = 'clientantiteleport / antiteleport (客户)', DESC = '防止本地脚本传送你'}
CMDs[#CMDs + 1] = {NAME = 'allowrejoin / allowrj [对/错] (客户)', DESC = '如果antiteleport允许您重新加入或不允许，则发生变化'}
CMDs[#CMDs + 1] = {NAME = 'cancelteleport / canceltp', DESC = '取消正在进行的传送'}
CMDs[#CMDs + 1] = {NAME = 'volume / vol [0-10]', DESC = '在0到10的范围内调节游戏音量'}
CMDs[#CMDs + 1] = {NAME = 'antilag / boostfps / lowgraphics', DESC = '降低游戏质量以提高FPS'}
CMDs[#CMDs + 1] = {NAME = 'record / rec', DESC = '启动roblox记录器'}
CMDs[#CMDs + 1] = {NAME = 'screenshot / scrnshot', DESC = '截图'}
CMDs[#CMDs + 1] = {NAME = 'togglefullscreen / togglefs', DESC = '切换全屏'}
CMDs[#CMDs + 1] = {NAME = 'notify [文本]', DESC = '向您发送包含所提供文本的通知'}
CMDs[#CMDs + 1] = {NAME = 'lastcommand / lastcmd', DESC = '执行先前使用的命令'}
CMDs[#CMDs + 1] = {NAME = 'exit', DESC = '终止roblox进程'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'noclip', DESC = '浏览对象'}
CMDs[#CMDs + 1] = {NAME = 'unnoclip / clip', DESC = '禁用noclip'}
CMDs[#CMDs + 1] = {NAME = 'fly [速度]', DESC = '让你飞翔'}
CMDs[#CMDs + 1] = {NAME = 'unfly', DESC = '禁用飞行'}
CMDs[#CMDs + 1] = {NAME = 'flyspeed [数字]', DESC = '设置飞行速度(默认为20)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclefly / vfly [速度]', DESC = '让你乘坐交通工具飞行'}
CMDs[#CMDs + 1] = {NAME = 'unvehiclefly / unvfly', DESC = '禁用车辆飞行'}
CMDs[#CMDs + 1] = {NAME = 'vehicleflyspeed  / vflyspeed [数字]', DESC = '设置车辆飞行速度'}
CMDs[#CMDs + 1] = {NAME = 'cframefly / cfly [速度]', DESC = '让你飞起来，绕过一些反作弊软件(适用于手机)'}
CMDs[#CMDs + 1] = {NAME = 'uncframefly / uncfly', DESC = '禁用cfly'}
CMDs[#CMDs + 1] = {NAME = 'cframeflyspeed  / cflyspeed [数字]', DESC = '设置cfly速度'}
CMDs[#CMDs + 1] = {NAME = 'qefly [true / false]', DESC = '启用或禁用飞行的Q和E热键'}
CMDs[#CMDs + 1] = {NAME = 'vehiclenoclip / vnoclip', DESC = '关闭车辆碰撞'}
CMDs[#CMDs + 1] = {NAME = 'vehicleclip / vclip / unvnoclip', DESC = '启用车辆碰撞'}
CMDs[#CMDs + 1] = {NAME = 'float /  platform', DESC = '在你下面产生一个平台，使你漂浮'}
CMDs[#CMDs + 1] = {NAME = 'unfloat / noplatform', DESC = '移除平台'}
CMDs[#CMDs + 1] = {NAME = 'swim', DESC = '允许你在空中游泳'}
CMDs[#CMDs + 1] = {NAME = 'unswim / noswim', DESC = '阻止你到处游泳'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'setwaypoint / swp [名字]', DESC = '在您的位置设置一个航路点'}
CMDs[#CMDs + 1] = {NAME = 'waypointpos / wpp [名字] [X Y Z]', DESC = '用指定的坐标设置航路点'}
CMDs[#CMDs + 1] = {NAME = 'waypoints', DESC = '显示当前活动航路点的列表'}
CMDs[#CMDs + 1] = {NAME = 'showwaypoints / showwp', DESC = '显示所有当前设置的航点'}
CMDs[#CMDs + 1] = {NAME = 'hidewaypoints / hidewp', DESC = '隐藏显示的航点'}
CMDs[#CMDs + 1] = {NAME = 'waypoint / wp [名字]', DESC = '将玩家传送到一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'tweenwaypoint / twp [名字]', DESC = '将玩家过渡到一个航路点'}
CMDs[#CMDs + 1] = {NAME = 'walktowaypoint / wtwp [名字]', DESC = '将玩家带到一个路点'}
CMDs[#CMDs + 1] = {NAME = 'deletewaypoint / dwp [名字]', DESC = '删除一个航点'}
CMDs[#CMDs + 1] = {NAME = 'clearwaypoints / cwp', DESC = '清除所有航路点'}
CMDs[#CMDs + 1] = {NAME = 'cleargamewaypoints / cgamewp', DESC = '清除游戏中的所有关卡'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'goto [用户名]', DESC = '去找玩家'}
CMDs[#CMDs + 1] = {NAME = 'tweengoto / tgoto [用户名]', DESC = '对一个玩家来说(绕过一些反作弊)'}
CMDs[#CMDs + 1] = {NAME = 'tweenspeed / tspeed [数字]', DESC = '设置所有补间命令的速度(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclegoto / vgoto [用户名]', DESC = '在车辆中时去找玩家'}
CMDs[#CMDs + 1] = {NAME = 'loopgoto [用户名] [距离] [耽搁]', DESC = '循环传送到玩家'}
CMDs[#CMDs + 1] = {NAME = 'unloopgoto', DESC = '停止将你传送给玩家'}
CMDs[#CMDs + 1] = {NAME = 'pulsetp / ptp [用户名] [秒]', DESC = '将你传送到一个玩家身边一段时间'}
CMDs[#CMDs + 1] = {NAME = 'clientbring / cbring [用户名] (客户)', DESC = '带一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'loopbring [用户名] [距离] [耽搁] (客户)', DESC = '循环带给你一个玩家(对杀戮有用)'}
CMDs[#CMDs + 1] = {NAME = 'unloopbring [用户名]', DESC = '撤消loopbring'}
CMDs[#CMDs + 1] = {NAME = 'freeze / fr [用户名] (客户)', DESC = '冻结玩家'}
CMDs[#CMDs + 1] = {NAME = 'freezeanims', DESC = '冻结动画/暂停动画-对默认动画无效'}
CMDs[#CMDs + 1] = {NAME = 'unfreezeanims', DESC = '解冻动画/播放动画'}
CMDs[#CMDs + 1] = {NAME = 'thaw / unfr [用户名] (客户)', DESC = '解冻玩家'}
CMDs[#CMDs + 1] = {NAME = 'tpposition / tppos [X Y Z]', DESC = '把你传送到特定的坐标'}
CMDs[#CMDs + 1] = {NAME = 'tweentpposition / ttppos [X Y Z]', DESC = '补间坐标(绕过一些反作弊)'}
CMDs[#CMDs + 1] = {NAME = 'offset [X Y Z]', DESC = '让你偏移一定的坐标'}
CMDs[#CMDs + 1] = {NAME = 'tweenoffset / toffset [X Y Z]', DESC = '补间偏移(绕过一些反作弊)'}
CMDs[#CMDs + 1] = {NAME = 'notifyposition / notifypos [用户名]', DESC = '通知你一个字符的坐标'}
CMDs[#CMDs + 1] = {NAME = 'copyposition / copypos [用户名]', DESC = '将字符的坐标复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'walktoposition / walktopos [X Y Z]', DESC = '让你走向坐标'}
CMDs[#CMDs + 1] = {NAME = 'spawnpoint / spawn [耽搁]', DESC = '设定一个你将产卵的位置'}
CMDs[#CMDs + 1] = {NAME = 'nospawnpoint / nospawn', DESC = '移除您的自定义产卵点'}
CMDs[#CMDs + 1] = {NAME = 'flashback / diedtp', DESC = '把你传送到你最后死去的地方'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'logs', DESC = '打开日志GUI'}
CMDs[#CMDs + 1] = {NAME = 'chatlogs / clogs', DESC = '记录人们说的话或窃窃私语'}
CMDs[#CMDs + 1] = {NAME = 'joinlogs / jlogs', DESC = '当人们加入时记录'}
CMDs[#CMDs + 1] = {NAME = 'chat / say [文本]', DESC = '让你聊天一串(可能静音旁路)'}
CMDs[#CMDs + 1] = {NAME = 'spam [文本]', DESC = '让你发送垃圾邮件聊天'}
CMDs[#CMDs + 1] = {NAME = 'unspam', DESC = '关闭垃圾邮件'}
CMDs[#CMDs + 1] = {NAME = 'whisper / pm [用户名] [文本]', DESC = '让你对某人耳语一串(可能静音旁路)'}
CMDs[#CMDs + 1] = {NAME = 'pmspam [用户名] [文本]', DESC = '让你发垃圾邮件给玩家'}
CMDs[#CMDs + 1] = {NAME = 'unpmspam [用户名]', DESC = '关闭pm垃圾邮件'}
CMDs[#CMDs + 1] = {NAME = 'spamspeed [数字]', DESC = '发送垃圾邮件的速度(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'bubblechat (客户)', DESC = '为您的客户端启用泡泡聊天'}
CMDs[#CMDs + 1] = {NAME = 'unbubblechat / nobubblechat', DESC = '禁用bubblechat命令'}
...
CMDs[#CMDs + 1] = {NAME = 'noesp / unesp', DESC = '移除esp'}
CMDs[#CMDs + 1] = {NAME = 'esptransparency [数字]', DESC = '更改esp相关命令的透明度'}
CMDs[#CMDs + 1] = {NAME = 'partesp [零件名称]', DESC = '突出显示零件'}
CMDs[#CMDs + 1] = {NAME = 'unpartesp / nopartesp [零件名称]', DESC = '删除partesp'}
CMDs[#CMDs + 1] = {NAME = 'chams', DESC = '尤指无正文的'}
CMDs[#CMDs + 1] = {NAME = 'nochams / unchams', DESC = '移除chams'}
CMDs[#CMDs + 1] = {NAME = 'locate [用户名]', DESC = '查看单个玩家及其状态'}
CMDs[#CMDs + 1] = {NAME = 'unlocate / nolocate [用户名]', DESC = '移除定位'}
CMDs[#CMDs + 1] = {NAME = 'xray', DESC = '使工作空间中的所有零件透明'}
CMDs[#CMDs + 1] = {NAME = 'unxray / noxray', DESC = '恢复透明度'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'spectate / view [用户名]', DESC = '查看玩家'}
CMDs[#CMDs + 1] = {NAME = 'viewpart / viewp [零件名称]', DESC = '查看零件'}
CMDs[#CMDs + 1] = {NAME = 'unspectate / unview', DESC = '停止查看播放器'}
CMDs[#CMDs + 1] = {NAME = 'freecam / fc', DESC = '允许你在游戏中自由移动相机'}
CMDs[#CMDs + 1] = {NAME = 'freecampos / fcpos [X Y Z]', DESC = '在某个位置移动/打开freecam'}
CMDs[#CMDs + 1] = {NAME = 'freecamwaypoint / fcwp [名字]', DESC = '移动/打开freecam到一个航路点'}
CMDs[#CMDs + 1] = {NAME = 'freecamgoto / fcgoto / fctp [用户名]', DESC = '向玩家移动/打开freecam'}
CMDs[#CMDs + 1] = {NAME = 'unfreecam / unfc', DESC = '禁用freecam'}
CMDs[#CMDs + 1] = {NAME = 'freecamspeed / fcspeed [数字]', DESC = '调整freecam速度(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'notifyfreecamposition / notifyfcpos', DESC = '通知你你的自由摄像机坐标'}
CMDs[#CMDs + 1] = {NAME = 'copyfreecamposition / copyfcpos', DESC = '将freecam坐标复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'gotocamera / gotocam', DESC = '传送你到你相机的位置'}
CMDs[#CMDs + 1] = {NAME = 'tweengotocam / tgotocam', DESC = '补间你到你的相机的位置'}
CMDs[#CMDs + 1] = {NAME = 'firstp', DESC = '强制镜头进入第一人称'}
CMDs[#CMDs + 1] = {NAME = 'thirdp', DESC = '允许摄像机进入第三人称'}
CMDs[#CMDs + 1] = {NAME = 'noclipcam / nccam', DESC = '允许摄像机穿过像墙壁这样的物体'}
CMDs[#CMDs + 1] = {NAME = 'maxzoom [数字]', DESC = '最大相机变焦'}
CMDs[#CMDs + 1] = {NAME = 'minzoom [数字]', DESC = '最小相机变焦'}
CMDs[#CMDs + 1] = {NAME = 'camdistance [数字]', DESC = '改变相机与玩家的距离'}
CMDs[#CMDs + 1] = {NAME = 'fov [数字]', DESC = '调整视野(默认为70°)'}
CMDs[#CMDs + 1] = {NAME = 'fixcam / restorecam', DESC = '修理照相机'}
CMDs[#CMDs + 1] = {NAME = 'enableshiftlock / enablesl', DESC = '启用换档锁定选项'}
CMDs[#CMDs + 1] = {NAME = 'lookat [用户名]', DESC = '将您的摄像机视图移动到玩家'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'btools (客户)', DESC = '为您提供构建工具(不复制)'}
CMDs[#CMDs + 1] = {NAME = 'f3x (客户)', DESC = '为您提供F3X构建工具(不复制)'}
CMDs[#CMDs + 1] = {NAME = 'partname / partpath', DESC = '允许您单击某个部件以查看其路径和名称'}
CMDs[#CMDs + 1] = {NAME = 'delete [实例名称] (客户)', DESC = '从工作区移除任何具有特定名称的零件(不复制)'}
CMDs[#CMDs + 1] = {NAME = 'deleteclass / dc [类别名] (客户)', DESC = '从工作区中删除任何具有特定类名的部分(不复制)'}
CMDs[#CMDs + 1] = {NAME = 'lockworkspace / lockws', DESC = '锁定整个工作区'}
CMDs[#CMDs + 1] = {NAME = 'unlockworkspace / unlockws', DESC = '解锁整个工作区'}
CMDs[#CMDs + 1] = {NAME = 'invisibleparts / invisparts (客户)', DESC = '显示不可见的部分'}
CMDs[#CMDs + 1] = {NAME = 'uninvisibleparts / uninvisparts (客户)', DESC = '使受不可见零件影响的零件恢复正常'}
CMDs[#CMDs + 1] = {NAME = 'deleteinvisparts / dip (客户)', DESC = '删除不可见的部分'}
CMDs[#CMDs + 1] = {NAME = 'gotopart [零件名称]', DESC = '将角色移动到一个或多个部分'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopart / tgotopart [零件名称]', DESC = '将角色补间到一个或多个部分'}
CMDs[#CMDs + 1] = {NAME = 'gotopartclass / gpc [类别名]', DESC = '基于类名将角色移动到一个或多个部分'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopartclass / tgpc [类别名]', DESC = '基于类名将角色补间到一个或多个部分'}
CMDs[#CMDs + 1] = {NAME = 'gotomodel [零件名称]', DESC = 'Moves your character to a model or multiple models'}
CMDs[#CMDs + 1] = {NAME = 'tweengotomodel / tgotomodel [零件名称]', DESC = '将角色补间到一个或多个模型'}
CMDs[#CMDs + 1] = {NAME = 'gotopartdelay / gotomodeldelay [数字]', DESC = '调整你传送到每个部分的速度(默认为0.1)'}
CMDs[#CMDs + 1] = {NAME = 'bringpart [零件名称] (客户)', DESC = '将一个或多个部分移动到角色'}
CMDs[#CMDs + 1] = {NAME = 'bringpartclass / bpc [类别名] (客户)', DESC = '基于类名将一个或多个部分移动到角色'}
CMDs[#CMDs + 1] = {NAME = 'noclickdetectorlimits / nocdlimits', DESC = '将所有点击检测器MaxActivationDistance设置为math.huge'}
CMDs[#CMDs + 1] = {NAME = 'fireclickdetectors / firecd [名字]', DESC = '使用游戏中的所有点击检测器或使用可选名称'}
CMDs[#CMDs + 1] = {NAME = 'firetouchinterests / touchinterests [名字]', DESC = '使用游戏中的所有接触兴趣或使用可选名称'}
CMDs[#CMDs + 1] = {NAME = 'noproximitypromptlimits / nopplimits', DESC = '将所有邻近提示MaxActivationDistance设置为math.huge'}
CMDs[#CMDs + 1] = {NAME = 'fireproximityprompts / firepp [名字]', DESC = '使用游戏中的所有接近提示或使用可选名称'}
...
CMDs[#CMDs + 1] = {NAME = 'tpunanchored / tpua [用户名]', DESC = '将未锚定的部分传送给玩家'}
CMDs[#CMDs + 1] = {NAME = 'animsunanchored / freezeua', DESC = '冻结未锚定的零件'}
CMDs[#CMDs + 1] = {NAME = 'thawunanchored / thawua / unfreezeua', DESC = '解冻未锚固的零件'}
CMDs[#CMDs + 1] = {NAME = 'removeterrain / rterrain / noterrain', DESC = '移除所有地形'}
CMDs[#CMDs + 1] = {NAME = 'clearnilinstances / nonilinstances / cni', DESC = '删除零实例'}
CMDs[#CMDs + 1] = {NAME = 'destroyheight / dh [数字]', DESC = '设置FallenPartsDestroyHeight'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'fullbright / fb (客户)', DESC = '使地图更亮/更明显'}
CMDs[#CMDs + 1] = {NAME = 'loopfullbright / loopfb (客户)', DESC = '使地图更亮/更明显，但呈环状'}
CMDs[#CMDs + 1] = {NAME = 'unloopfullbright / unloopfb', DESC = '放开富布赖特'}
CMDs[#CMDs + 1] = {NAME = 'ambient [数字] (客户)', DESC = '改变环境'}
CMDs[#CMDs + 1] = {NAME = 'day (客户)', DESC = '更改客户端的时间'}
CMDs[#CMDs + 1] = {NAME = 'night (客户)', DESC = '将客户端的时间更改为晚上'}
CMDs[#CMDs + 1] = {NAME = 'nofog (客户)', DESC = '去除雾气'}
CMDs[#CMDs + 1] = {NAME = 'brightness [数字] (客户)', DESC = '更改亮度照明属性'}
CMDs[#CMDs + 1] = {NAME = 'globalshadows / gshadows (客户)', DESC = '启用全局阴影'}
CMDs[#CMDs + 1] = {NAME = 'noglobalshadows / nogshadows (客户)', DESC = '禁用全局阴影'}
CMDs[#CMDs + 1] = {NAME = 'restorelighting / rlighting', DESC = '恢复照明属性'}
CMDs[#CMDs + 1] = {NAME = 'light [半径] [聪明] (客户)', DESC = '给你的玩家动态的光'}
CMDs[#CMDs + 1] = {NAME = 'nolight / unlight', DESC = '从你的播放器上移除动态光'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'inspect / examine [用户名]', DESC = '为某个玩家打开检查菜单'}
CMDs[#CMDs + 1] = {NAME = 'age [用户名]', DESC = '告诉你一个玩家的年龄'}
CMDs[#CMDs + 1] = {NAME = 'chatage [用户名]', DESC = '聊球员的年龄'}
CMDs[#CMDs + 1] = {NAME = 'joindate / jd [用户名]', DESC = '告诉你玩家加入Roblox的日期'}
CMDs[#CMDs + 1] = {NAME = 'chatjoindate / cjd [用户名]', DESC = '聊天玩家加入Roblox的日期'}
CMDs[#CMDs + 1] = {NAME = 'copyname / copyuser [用户名]', DESC = '将玩家的完整用户名复制到你的剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'userid / id [用户名]', DESC = '通知玩家的用户ID'}
CMDs[#CMDs + 1] = {NAME = 'copyuserid / copyid [用户名]', DESC = '将玩家的用户ID复制到你的剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'appearanceid / aid [用户名]', DESC = '通知玩家外观ID'}
CMDs[#CMDs + 1] = {NAME = 'copyappearanceid / caid [用户名]', DESC = '将玩家的外貌ID复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'bang [用户名] [速度]', DESC = 'owo 你看见动作很神奇'}
CMDs[#CMDs + 1] = {NAME = 'unbang', DESC = 'uwu'}
CMDs[#CMDs + 1] = {NAME = 'carpet [用户名]', DESC = '成为某人的地毯'}
CMDs[#CMDs + 1] = {NAME = 'uncarpet', DESC = '解开地毯'}
CMDs[#CMDs + 1] = {NAME = 'friend [用户名]', DESC = '向某些玩家发送好友请求'}
CMDs[#CMDs + 1] = {NAME = 'unfriend [用户名]', DESC = '取消某些玩家的好友关系'}
CMDs[#CMDs + 1] = {NAME = 'headsit [用户名]', DESC = '坐在玩家的头上'}
CMDs[#CMDs + 1] = {NAME = 'walkto / follow [用户名]', DESC = '追随一名运动员'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalkto / pathfindfollow [用户名]', DESC = '使用寻路追踪玩家'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalktowaypoint / pathfindwalktowp [航点]', DESC = '使用寻路功能走到一个航路点'}
CMDs[#CMDs + 1] = {NAME = 'unwalkto / unfollow', DESC = '停止跟踪玩家'}
CMDs[#CMDs + 1] = {NAME = 'stareat / stare [用户名]', DESC = '盯着/看着一名运动员'}
CMDs[#CMDs + 1] = {NAME = 'unstareat / unstare [用户名]', DESC = '禁用stareat'}
CMDs[#CMDs + 1] = {NAME = 'rolewatch [小组id] [角色名称]', DESC = '如果有人从被关注的群组加入服务器，则发出通知'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchstop / unrolewatch', DESC = '禁用角色手表'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchleave', DESC = '如果有人加入服务器，你是否应该离开游戏'}
CMDs[#CMDs + 1] = {NAME = 'attach [用户名] (工具)', DESC = '将你连接到一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'kill [用户名] (工具)', DESC = '杀死一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fastkill [用户名] (工具)', DESC = '杀死一个玩家(不太可靠)(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'handlekill / hkill [用户名] (工具)', DESC = '使用工具伤害杀死玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'bring [用户名] (工具)', DESC = '带来一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fastbring [用户名] (工具)', DESC = '带来一个玩家(不太可靠)(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'teleport / tp [用户名] (工具)', DESC = '将一个玩家传送到另一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fastteleport / fasttp [用户名] (工具)', DESC = '将一个玩家传送到另一个玩家(不太可靠)(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fling', DESC = '甩你碰到的任何人'}
CMDs[#CMDs + 1] = {NAME = 'unfling', DESC = '禁用fling命令'}
CMDs[#CMDs + 1] = {NAME = 'invisfling', DESC = '启用隐形放纵'}
CMDs[#CMDs + 1] = {NAME = 'loopoof', DESC = '循环播放每个人的角色声音(每个人都能听到)'}
CMDs[#CMDs + 1] = {NAME = 'unloopoof', DESC = '停止混乱'}
CMDs[#CMDs + 1] = {NAME = 'muteboombox [用户名]', DESC = '将某人的音箱静音'}
CMDs[#CMDs + 1] = {NAME = 'unmuteboombox [用户名]', DESC = '取消某人的音箱静音'}
CMDs[#CMDs + 1] = {NAME = 'hitbox [用户名] [大小]', DESC = '扩展玩家的hitbox HumanoidRootPart(默认为1)'}
CMDs[#CMDs + 1] = {NAME = 'headsize [用户名] [大小]', DESC = '扩展玩家头部的尺寸(默认为1)'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'reset', DESC = '正常重置您的角色'}
CMDs[#CMDs + 1] = {NAME = 'respawn', DESC = '让你重生'}
CMDs[#CMDs + 1] = {NAME = 'refresh / re', DESC = '呼吸并把你带回到相同的位置'}
CMDs[#CMDs + 1] = {NAME = 'god', DESC = '让你的角色在大多数游戏中很难被杀死'}
...
CMDs[#CMDs + 1] = {NAME = 'speed / ws / walkspeed [数字]', DESC = '改变你的步行速度'}
CMDs[#CMDs + 1] = {NAME = 'spoofspeed / spoofws [数字]', DESC = '在客户端欺骗你的步行速度'}
CMDs[#CMDs + 1] = {NAME = 'loopspeed / loopws [数字]', DESC = '循环你的步行速度'}
CMDs[#CMDs + 1] = {NAME = 'unloopspeed / unloopws', DESC = '关闭循环速度'}
CMDs[#CMDs + 1] = {NAME = 'hipheight / hheight [数字]', DESC = '调节臀部高度'}
CMDs[#CMDs + 1] = {NAME = 'jumppower / jpower / jp [数字]', DESC = '改变玩家的跳跃高度'}
CMDs[#CMDs + 1] = {NAME = 'spoofjumppower / spoofjp [数字]', DESC = '在客户端上欺骗你的跳跃能力'}
CMDs[#CMDs + 1] = {NAME = 'loopjumppower / loopjp [数字]', DESC = '循环你的跳跃高度'}
CMDs[#CMDs + 1] = {NAME = 'unloopjumppower / unloopjp', DESC = '关闭loopjumppower'}
CMDs[#CMDs + 1] = {NAME = 'maxslopeangle / msa [数字]', DESC = '调整最大倾斜角度'}
CMDs[#CMDs + 1] = {NAME = 'gravity / grav [数字] (客户)', DESC = '改变你的重力'}
CMDs[#CMDs + 1] = {NAME = 'sit', DESC = '让你的角色坐下'}
CMDs[#CMDs + 1] = {NAME = 'lay / laydown', DESC = '让你的角色躺下'}
CMDs[#CMDs + 1] = {NAME = 'sitwalk', DESC = '让您的角色坐着，同时仍然能够行走'}
CMDs[#CMDs + 1] = {NAME = 'nosit', DESC = '防止您的角色坐着'}
CMDs[#CMDs + 1] = {NAME = 'unnosit', DESC = '禁用nosit'}
CMDs[#CMDs + 1] = {NAME = 'jump', DESC = '让你的角色跳跃'}
CMDs[#CMDs + 1] = {NAME = 'infinitejump / infjump', DESC = '允许你在落地前跳跃'}
CMDs[#CMDs + 1] = {NAME = 'uninfinitejump / uninfjump', DESC = '禁用infjump'}
CMDs[#CMDs + 1] = {NAME = 'flyjump', DESC = '允许你保持空间向上飞'}
CMDs[#CMDs + 1] = {NAME = 'unflyjump', DESC = '禁用快速跳转'}
CMDs[#CMDs + 1] = {NAME = 'autojump / ajump', DESC = '当你碰到一个物体时会自动跳跃'}
CMDs[#CMDs + 1] = {NAME = 'unautojump / unajump', DESC = '禁用自动跳转'}
CMDs[#CMDs + 1] = {NAME = 'edgejump / ejump', DESC = '当到达对象边缘时自动跳转'}
CMDs[#CMDs + 1] = {NAME = 'unedgejump / unejump', DESC = '禁用边缘跳跃'}
CMDs[#CMDs + 1] = {NAME = 'platformstand / stun', DESC = '启用平台支架'}
CMDs[#CMDs + 1] = {NAME = 'unplatformstand / unstun', DESC = '禁用平台支架'}
CMDs[#CMDs + 1] = {NAME = 'norotate / noautorotate', DESC = '禁用自动旋转'}
CMDs[#CMDs + 1] = {NAME = 'unnorotate / autorotate', DESC = '启用自动旋转'}
CMDs[#CMDs + 1] = {NAME = 'enablestate [状态类型]', DESC = '启用人形状态类型'}
CMDs[#CMDs + 1] = {NAME = 'disablestate [状态类型]', DESC = '禁用人形状态类型'}
CMDs[#CMDs + 1] = {NAME = 'team [团队名称] (客户)', DESC = '改变你的团队。有时愚弄本地脚本'}
...
CMDs[#CMDs + 1] = {NAME = 'unloopnobgui / unloopnoname', DESC = '禁用loopnobgui'}
CMDs[#CMDs + 1] = {NAME = 'nohead / headless', DESC = '移除您的头部(使用模拟半径)'}
CMDs[#CMDs + 1] = {NAME = 'noarms', DESC = '卸下你的手臂'}
CMDs[#CMDs + 1] = {NAME = 'nolegs', DESC = '去掉你的腿'}
CMDs[#CMDs + 1] = {NAME = 'nolimbs', DESC = '切除你的四肢'}
CMDs[#CMDs + 1] = {NAME = 'naked (客户)', DESC = '脱掉你的衣服'}
...
CMDs[#CMDs + 1] = {NAME = 'creeper', DESC = '让你看起来像个爬虫'}
CMDs[#CMDs + 1] = {NAME = 'drophats', DESC = '放下你的帽子'}
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats / rhats', DESC = '删除你的帽子'}
CMDs[#CMDs + 1] = {NAME = 'hatspin / spinhats', DESC = '旋转您的角色配件'}
CMDs[#CMDs + 1] = {NAME = 'unhatspin / unspinhats', DESC = '关闭 spinhats'}
CMDs[#CMDs + 1] = {NAME = 'clearhats / cleanhats', DESC = '清除工作区中的帽子'}
CMDs[#CMDs + 1] = {NAME = 'chardelete / cd [实例名称]', DESC = '从角色中移除具有特定名称的任何部分'}
CMDs[#CMDs + 1] = {NAME = 'chardeleteclass / cdc [类别名]', DESC = '从角色中移除具有特定类名的任何部分'}
CMDs[#CMDs + 1] = {NAME = 'deletevelocity / dv / removeforces', DESC = '移除角色中的任何速度/力实例'}
CMDs[#CMDs + 1] = {NAME = 'weaken [数字]', DESC = '让你的角色不那么密集'}
CMDs[#CMDs + 1] = {NAME = 'unweaken', DESC = '将角色的CustomPhysicalProperties设置为默认值'}
CMDs[#CMDs + 1] = {NAME = 'strengthen [数字]', DESC = '使您的角色更加密集(CustomPhysicalProperties)'}
CMDs[#CMDs + 1] = {NAME = 'unstrengthen', DESC = '将角色的CustomPhysicalProperties设置为默认值'}
CMDs[#CMDs + 1] = {NAME = 'breakvelocity', DESC = '将角色速度设定为0'}
CMDs[#CMDs + 1] = {NAME = 'spin [速度]', DESC = '旋转您的角色'}
CMDs[#CMDs + 1] = {NAME = 'unspin', DESC = '禁用旋转'}
CMDs[#CMDs + 1] = {NAME = 'vr (手机无法使用)', DESC = '通过Abacaxl加载CLOVR(手机无法使用'}
CMDs[#CMDs + 1] = {NAME = 'split', DESC = '将您的角色分成两半'}
CMDs[#CMDs + 1] = {NAME = 'nilchar', DESC = '将角色的父代设置为零'}
CMDs[#CMDs + 1] = {NAME = 'unnilchar / nonilchar', DESC = '将角色的父对象设置为工作空间'}
CMDs[#CMDs + 1] = {NAME = 'noroot / removeroot / rroot', DESC = '移除你的角色'}
CMDs[#CMDs + 1] = {NAME = 'replaceroot', DESC = '替换您的角色'}
CMDs[#CMDs + 1] = {NAME = 'clearcharappearance / clearchar / clrchar', DESC = '移除所有附件、衬衫、裤子、角色网格和身体颜色'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'animation / anim [ID] [速度]', DESC = '使您的角色执行动画(必须由roblox来复制)'}
CMDs[#CMDs + 1] = {NAME = 'dance', DESC = '让你成为跳舞'}
CMDs[#CMDs + 1] = {NAME = 'undance', DESC = '停止舞蹈动画'}
CMDs[#CMDs + 1] = {NAME = 'spasm', DESC = '让你变得疯狂'}
CMDs[#CMDs + 1] = {NAME = 'unspasm', DESC = '停止spasm'}
CMDs[#CMDs + 1] = {NAME = 'headthrow', DESC = '只会让你把头抬起来'}
CMDs[#CMDs + 1] = {NAME = 'noanim', DESC = '禁用您的动画'}
CMDs[#CMDs + 1] = {NAME = 'reanim', DESC = '恢复动画'}
CMDs[#CMDs + 1] = {NAME = 'animspeed [数字]', DESC = '更改当前动画的速度'}
CMDs[#CMDs + 1] = {NAME = 'copyanimation / copyanim / copyemote [用户名]', DESC = '复制别人的动画'}
CMDs[#CMDs + 1] = {NAME = 'loopanimation / loopanim', DESC = '循环播放当前动画'}
CMDs[#CMDs + 1] = {NAME = 'stopanimations / stopanims', DESC = '停止运行动画'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'autoclick [点击延迟] [释放延迟]', DESC = '在设定的延迟时间内自动点击鼠标'}
CMDs[#CMDs + 1] = {NAME = 'unautoclick / noautoclick', DESC = '关闭自动点击'}
CMDs[#CMDs + 1] = {NAME = 'autokeypress [键] [向下延迟] [上行延迟]', DESC = '在设定的延迟时间内自动按键'}
CMDs[#CMDs + 1] = {NAME = 'unautokeypress', DESC = '停止自动按键'}
CMDs[#CMDs + 1] = {NAME = 'hovername', DESC = '当你的鼠标停留在玩家身上时显示他们的用户名'}
CMDs[#CMDs + 1] = {NAME = 'unhovername / nohovername', DESC = '关闭hovername'}
CMDs[#CMDs + 1] = {NAME = 'mousesensitivity / ms [0-10]', DESC = '设置鼠标敏感度(影响第一人称和右键拖动)(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'clickdelete', DESC = '进入设置>按键绑定>为clicktp添加'}
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = '前往设置>按键绑定>添加以点击tp'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'tools', DESC = '从复制的存储和照明中复制工具'}
CMDs[#CMDs + 1] = {NAME = 'notools / removetools / deletetools', DESC = '从角色和背包中移除工具'}
CMDs[#CMDs + 1] = {NAME = 'deleteselectedtool / dst', DESC = '移除任何当前选定的工具'}
CMDs[#CMDs + 1] = {NAME = 'grabtools', DESC = '自动获取丢弃的工具'}
CMDs[#CMDs + 1] = {NAME = 'ungrabtools / nograbtools', DESC = '禁用grabtools'}
CMDs[#CMDs + 1] = {NAME = 'copytools [用户名] (客户)', DESC = '复制玩家工具'}
CMDs[#CMDs + 1] = {NAME = 'dupetools / clonetools [数字]', DESC = '多次复制你的库存工具'}
CMDs[#CMDs + 1] = {NAME = 'givetool / givetools', DESC = '使用attach方法将所有工具提供给[plr]。'}
CMDs[#CMDs + 1] = {NAME = 'droptools', DESC = '放下你的工具'}
CMDs[#CMDs + 1] = {NAME = 'droppabletools', DESC = '让您的工具可丢弃'}
CMDs[#CMDs + 1] = {NAME = 'equiptools', DESC = '一次装备你库存中的所有工具'}
CMDs[#CMDs + 1] = {NAME = 'unequiptools', DESC = '让你现在拿着的每一件工具立刻变得不一样'}
CMDs[#CMDs + 1] = {NAME = 'removespecifictool [名字]', DESC = '自动从库存中删除特定工具'}
CMDs[#CMDs + 1] = {NAME = 'unremovespecifictool [名字]', DESC = '停止从库存中移除特定工具'}
CMDs[#CMDs + 1] = {NAME = 'clearremovespecifictool', DESC = '停止从库存中移除所有特定的工具'}
CMDs[#CMDs + 1] = {NAME = 'reach [数字]', DESC = '增加你手持工具的生命值'}
CMDs[#CMDs + 1] = {NAME = 'unreach / noreach', DESC = '关闭延伸'}
CMDs[#CMDs + 1] = {NAME = 'grippos [X Y Z]', DESC = '更改当前的工具夹点位置'}
CMDs[#CMDs + 1] = {NAME = 'usetools [ammount] [耽搁]', DESC = '同时激活背包中的所有工具'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addalias [煤矿管理局] [别名]', DESC = '向命令添加别名'}
CMDs[#CMDs + 1] = {NAME = 'removealias [别名]', DESC = '删除自定义别名'}
CMDs[#CMDs + 1] = {NAME = 'clraliases', DESC = '删除所有自定义别名'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addplugin / plugin [名字]', DESC = '通过命令添加插件'}
CMDs[#CMDs + 1] = {NAME = 'removeplugin / deleteplugin [名字]', DESC = '通过命令删除插件'}
CMDs[#CMDs + 1] = {NAME = 'reloadplugin [名字]', DESC = '重新加载插件'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'breakloops / break (cmd环路)', DESC = '停止任何cmd循环(；100^1^cmd)'}
CMDs[#CMDs + 1] = {NAME = 'removecmd / deletecmd', DESC = '删除命令，直到管理员重新加载'}
CMDs[#CMDs + 1] = {NAME = 'tpwalk / teleportwalk [数字]', DESC = '传送你到你的移动方向'}
CMDs[#CMDs + 1] = {NAME = 'untpwalk / unteleportwalk', DESC = '撤消行走/瞬间移动'}
CMDs[#CMDs + 1] = {NAME = 'notifyping / ping', DESC = '通知自己您的ping'}
CMDs[#CMDs + 1] = {NAME = 'trip', DESC = '让你的角色倒下'}
